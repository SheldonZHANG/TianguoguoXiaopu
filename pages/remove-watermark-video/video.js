...
Page({
    ...
    onLoad: function () {
        console.log("remove_watermark_videosrc:" + app.globalData.remove_watermark_videosrc)
        console.log("dataUrl:" + this.getdataUrl('dataUrl'))
        this.getdataUrl('dataUrl')
        this.setData({
            videoSrc: app.globalData.remove_watermark_videosrc,
    ...
    download: function () {
        ...
        console.log("watermark-removed video url:" + e)
        wx.showLoading({
            title: '保存中 0%'
        }), (n = wx.downloadFile({
            url: e,
